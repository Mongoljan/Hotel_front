            ...
            <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as typeof activeTab)} className="space-y-4">
              ...
              <TabsContent value="location" className="mt-4">
                <div className="relative ">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-[1fr_500px] gap-4">
                    <div className="flex flex-col gap-4 lg:h-[320px] min-w-0">
                    ...
                    <div className="h-[280px] lg:h-[320px] w-full rounded-lg overflow-hidden border bg-muted/30 mb-[16px]">
                      {(() => {
              ...
              <TabsContent value="services" className="mt-4">
                <ServicesTab
                  ...
                  accessibilityFeatures={propertyDetail?.accessibility_feature || []}
